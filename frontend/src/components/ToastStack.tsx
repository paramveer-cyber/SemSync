...
const URGENCY: Record<Toast['urgency'], { color: string; border: string; bg: string; Icon: any }> = {
  ...
  low:    { color: 'var(--color-brand)', border: 'rgba(var(--color-brand-raw,34,197,94),0.35)', bg: 'rgba(var(--color-brand-raw,34,197,94),0.05)',  Icon: Info },
};
...
export default function ToastStack() {
  ...
  return (
    <div className="fixed top-4 right-4 left-4 sm:left-auto z-9999 flex flex-col gap-2 pointer-events-none sm:max-w-[360px]">
      {toasts.map(t => {
