...
const TIER_DRAW_SECONDS: Record<string, number> = {
    platinum: 0.6,
    legendary: 0.9,
    hidden: 0.75,
};
...
function SingleCinematic({
    ...
    const drawSeconds = TIER_DRAW_SECONDS[achievement.tier] ?? 0.6;
    const emojiDelay = reducedMotion ? 0.1 : drawSeconds;
        ...
        >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                animation: showContent
                                    ? `cinematic-ring 3.8s ease-in-out ${i * 0.45}s infinite`
                                    : 'none',
                            }}
                        />
                    ))}
            ...
            <div
                style={{
                    ...
                    transition:
                        'opacity 0.4s ease, transform 0.42s cubic-bezier(0.22,1,0.36,1)',
                }}
            >
                {/* Tier label */}
                <div
                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            opacity: visible ? 1 : 0,
                            transition: `transform 0.5s cubic-bezier(0.175,0.885,0.32,1.275) ${emojiDelay}s, opacity 0.4s ease ${emojiDelay}s`,
                        }}
                    >
                        {achievement.emoji}
                    </div>
                ...
                <div
                    style={{
                        ...
                        color: palette.primary,
                        textShadow: `0 0 22px ${palette.glow}`,
                        marginBottom: '2rem',
                        opacity: showContent ? 1 : 0,
                        transform: showContent ? 'scale(1)' : 'scale(0.8)',
                        transition:
                            'opacity 0.3s ease 0.3s, transform 0.35s cubic-bezier(0.175,0.885,0.32,1.275) 0.3s',
                    }}
                >
                ...
                <button
                    ...
                    style={{
                        ...
                        transition:
                            'opacity 0.3s ease, background 0.15s, box-shadow 0.15s',
                    }}
                    onMouseEnter={(e) => {
                        (
