...
export default function EditEvalModal({
    evaluation,
    onClose,
    onUpdated,
    existingWeight = 0,
    ...
    const availableWeight = r1(
        100 - r1(existingWeight) + r1(evaluation.weightage),
    );
    ...
    const handleSubmit = async (
        ...
        if (r1(newWeight) > availableWeight) {
            setLoading(false);
            return setError(
                `Weightage exceeds available weight. Max allowed: ${availableWeight}%.`,
            );
        }
