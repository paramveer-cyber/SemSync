...
export const ALL_ACHIEVEMENTS = [
    ...
    },
    {
        ...
        xp: 50,
        name: 'Marked',
        desc: 'Enter your first evaluation score',
        hidden: false,
    },
    {
        id: 'first_order',
    ...
    },
    {
        ...
        xp: 25,
        name: 'Full Picture',
        desc: 'Open the Progress page for the first time',
        hidden: false,
    },
    {
        id: 'system_online',
        ...
        xp: 60,
        name: 'System Online',
        desc: 'Complete a focus session linked to a task or evaluation',
        hidden: false,
    },
    // Streak
    {
    ...
    },
    {
        ...
        xp: 200,
        name: 'Weekly Anchor',
        desc: 'Study at least once every week for 8 consecutive weeks',
        hidden: false,
    },
    {
        id: 'clockwork',
        ...
        xp: 175,
        name: 'Clockwork',
        desc: 'Study in the same 2-hour window for 10 consecutive days',
        hidden: false,
    },
    {
        id: 'daily_driver',
        ...
        xp: 200,
        name: 'Daily Driver',
        desc: 'Complete at least one daily goal every day for 14 days straight',
        hidden: false,
    },
    {
        id: 'perfect_briefing',
        ...
        desc: 'Complete all daily goals for 7 consecutive days',
        hidden: false,
    },
    // Deep Work
    {
        ...
        xp: 200,
        name: 'Flow State',
        desc: 'Complete a 90-minute session with integrity ≥ 0.85',
        hidden: false,
    },
    {
        id: 'signal_noise',
        ...
        xp: 175,
        name: 'Signal/Noise',
        desc: 'Complete 5 sessions with integrity ≥ 0.9',
        hidden: false,
    },
    {
        id: 'the_monolith',
    ...
    },
    {
        ...
        tier: 'gold',
        xp: 400,
        name: "Surgeon's Hours",
        desc: 'Complete 10 sessions each with integrity ≥ 0.9',
        hidden: false,
    },
    {
        id: 'the_depth_protocol',
        emoji: '🌊',
        tier: 'platinum',
        xp: 750,
        name: 'The Depth Protocol',
        desc: 'Log 50 hours of high-integrity work (integrity ≥ 0.8)',
        hidden: false,
    },
    {
        id: 'traceable',
        ...
        xp: 225,
        name: 'Traceable',
        desc: 'Link every session to a task or eval for 14 consecutive days',
        hidden: false,
    },
    {
        id: 'the_compound',
        ...
        xp: 400,
        name: 'The Compound',
        desc: 'Complete 200 total focus sessions',
        hidden: false,
    },
    // Evaluation
    {
        ...
        xp: 75,
        name: 'The Setup',
        desc: 'Study for an evaluation at least 72h before its deadline',
        hidden: false,
    },
    {
        id: 'above_target',
        ...
        xp: 150,
        name: 'Above Target',
        desc: 'Score above your target grade on any evaluation',
        hidden: false,
    },
    {
        id: 'holding_the_line',
        ...
        desc: 'Beat your target grade on 3 consecutive evaluations in one course',
        hidden: false,
    },
    {
        id: 'course_complete',
        ...
        desc: 'Enter scores for every evaluation in a course',
        hidden: false,
    },
    {
        id: 'clean_sheet',
        ...
        xp: 400,
        name: 'Clean Sheet',
        desc: 'Score above target on every evaluation in a course',
        hidden: false,
    },
    {
        id: 'on_track',
        ...
        xp: 80,
        name: 'On Track',
        desc: 'Maintain a course average at or above your target grade',
        hidden: false,
    },
    {
        id: 'no_surprises',
        ...
        xp: 125,
        name: 'No Surprises',
        desc: 'Study for an eval at least 72 hours before it is due',
        hidden: false,
    },
    {
        id: 'the_standard',
        ...
        xp: 500,
        name: 'The Standard',
        desc: 'Keep every active course at or above its target grade simultaneously',
        hidden: false,
    },
    // Course / Planning
    {
    ...
    },
    {
        ...
        xp: 150,
        name: 'Course Closed',
        desc: 'Archive your first completed course',
        hidden: false,
    },
    {
        id: 'no_loose_ends',
        ...
        xp: 150,
        name: 'No Loose Ends',
        desc: 'Add at least one weighted evaluation to every active course',
        hidden: false,
    },
    {
        id: 'architect',
        ...
        xp: 175,
        name: 'Architect',
        desc: 'Fully configure every active course (name, target grade, 2+ evals)',
        hidden: false,
    },
    {
        id: 'the_blueprint',
        ...
        xp: 300,
        name: 'The Blueprint',
        desc: 'Configure all courses and evals before logging your first session',
        hidden: false,
    },
    {
        id: 'self_aware',
        ...
        xp: 50,
        name: 'Self-Aware',
        desc: 'Set target grades for all active courses',
        hidden: false,
    },
    {
        id: 'fully_loaded',
        ...
        xp: 125,
        name: 'Fully Loaded',
        desc: 'Make evaluations in a course total exactly 100% weightage',
        hidden: false,
    },
    // Comeback
    {
        ...
        xp: 150,
        name: 'Scar Tissue',
        desc: 'Return after 5+ days of inactivity',
        hidden: false,
    },
    {
        id: 'still_here',
    ...
    },
    {
        ...
        desc: 'Build a 14-day streak after previously breaking a streak of 21+',
        hidden: false,
    },
    {
        id: 'resilience_index',
        ...
        desc: 'Return from a 3+ day gap on 3 separate occasions',
        hidden: false,
    },
    {
        id: 'rebuilt',
        ...
        xp: 450,
        name: 'Rebuilt',
        desc: 'Reach a 21-day streak after previously breaking one of 21+',
        hidden: false,
    },
    ...
    // Legendary
    {
        ...
        xp: 2500,
        name: 'Chronos',
        desc: 'Maintain a 365-day streak',
        hidden: false,
    },
    {
        id: 'valedictorian',
        ...
        xp: 2000,
        name: 'Valedictorian',
        desc: 'Master every system: 200+ sessions, 100+ tasks completed, all courses above target',
        hidden: false,
    },
];
