    ...
    <div className="flex min-h-screen bg-black">
      ...
      <main className="grow flex flex-col overflow-hidden">
        ...
        <div className="grow overflow-y-auto p-8 max-w-3xl">
          <div className="p-8 border border-zinc-800 bg-zinc-900/50 rounded-[5px] text-zinc-400 space-y-8 text-sm leading-relaxed">
            
            <section>
              <h2 className="text-xl font-bold text-white mb-3">1. Terms of Service & Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white mb-3">3. Data Ownership</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white mb-3">4. Copyright Infringement</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white mb-3">5. Updates to Terms</h2>
              <p>
