...
import { getGamificationDashboard, trackPageVisit } from "../lib/api";
...
function flameTier(n: number) {
  if (n >= 90)
    return { emoji: "🌟", color: "#c0a8ff", glow: "rgba(192,168,255,0.55)" };
  if (n >= 30)
  ...
  return { emoji: "🔥", color: "var(--color-text-faint)", glow: "transparent" };
}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <Icon
          className="w-4 h-4"
          style={{ color: color ?? "var(--color-brand)", opacity: 0.6 }}
        />
      </div>
      <div
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: hover && earned ? "translateY(-2px)" : "translateY(0)",
    ...
    >
      ...
      <div
        ...
        style={{
          background: earned ? `${ts.color}10` : "rgba(255,255,255,0.025)",
      ...
      >
        ...
        <span
          style={{
            fontSize: 32,
            filter: earned ? `drop-shadow(0 0 8px ${ts.glow})` : "grayscale(1)",
      ...
      <div className="space-y-1">
        <p
          ...
          style={{ color: earned ? ts.color : "var(--color-text-muted)" }}
        >
          {isHidden ? "???" : a.name}
        </p>
        <p
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: allDone ? "0 0 18px var(--color-brand-glow)" : undefined,
...
export default function ProgressPage() {
        ...
        getGamificationDashboard()
          .then((d: any) => {
            setData({
              ...
              catalog:
                d.catalog ??
                (d.earned ?? []).map((e: EarnedAchievement) => ({
                  id: e.achievementId,
                  tier: e.tier,
                  hidden: false,
                  earned: true,
  ...
  catalog
    .filter((a) => a.earned)
    .forEach((a) => {
      if (a.tier in tierCounts) tierCounts[a.tier as keyof typeof tierCounts]++;
    });
              ...
              <div>
                ...
                <div className="flex justify-between mt-1.5">
                  ...
                  <span
                    ...
                    style={{ color: "var(--color-text-faint)" }}
                  >
                    {(xpNeeded - xpInLevel).toLocaleString()} XP remaining
                  </span>
                </div>
              </div>
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              value={
                streak ? (
                  ...
                  >
                    ...
                    <CountUp target={streak.currentStreak} />
                  </span>
                ) : (
                  "—"
                )
            ...
            <StatCard
              ...
              value={
                <>
                  <CountUp
                    target={Math.round((stats?.totalMinutes ?? 0) / 60)}
                  />
                  <span style={{ fontSize: 18, opacity: 0.5 }}>h</span>
                </>
              }
            ...
            <StatCard
              ...
              delay={0.15}
              value={
                <CountUp target={catalog.filter((a) => a.earned).length} />
              }
                ...
                style={{
                  borderColor:
                    streak.currentStreak >= 30
                      ? flameTier(streak.currentStreak).color + "33"
                      : undefined,
                  boxShadow:
                    streak.currentStreak >= 30
                ...
                {streak.freezeCount > 0 && (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: "var(--color-text-muted)" }}
                    >
                      {streak.freezeCount} streak freeze
                      {streak.freezeCount !== 1 ? "s" : ""} available
                    </span>
                  </div>
                )}
              </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
              <div className="flex items-baseline gap-3">
                ...
                <span
                  ...
                  style={{ color: "var(--color-text-faint)" }}
                >
                  {catalog.filter((a) => a.earned).length}/{catalog.length}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                  ...
                  {(Object.keys(TIER) as string[]).map((t) => (
                    <button
                      key={t}
                      onClick={() =>
                      ...
                      style={{
                        background:
                          tierFilter === t ? TIER[t].bg : "transparent",
                        color:
                          tierFilter === t
                            ? TIER[t].color
                            : "var(--color-text-faint)",
                    ...
                    >
                      {TIER[t].badge}
                      {tierCounts[t as keyof typeof tierCounts] > 0 && (
                ...
                >
                  {(["all", "earned", "locked"] as const).map((f) => (
                    <button
                      ...
                      style={{
                        background:
                          filter === f ? "var(--color-brand)" : "transparent",
                        color:
                          filter === f
                            ? "var(--color-surface)"
                            : "var(--color-text-faint)",
              ...
              <div className="card p-12 text-center">
                ...
                {filter === "earned" && (
                  <p
                    ...
                    style={{ color: "var(--color-text-faint)" }}
                  >
                    Start a focus session to unlock your first one.
                  </p>
                )}
              </div>
            )}
