...
function TaskCard({
    ...
    const springTransition = reducedMotion ? { duration: 0 } : KANBAN_SPRING;
    ...
    return (
        <motion.div
            ...
            className='group relative flex flex-col cursor-grab active:cursor-grabbing select-none hover:bg-[var(--color-surface-2)]'
            style={{
        ...
        >
            <div className='flex items-center justify-between mb-4'>
                ...
                <div className='flex items-center gap-2'>
                    {task.status === 'done' ? (
                        ...
                        <span
                            className='flex items-center gap-1 text-4xs font-black tracking-widest uppercase px-2 py-0.5'
                            style={{
                                color: pm.color,
            ...
            <p
                className='text-sm font-extrabold tracking-tight uppercase leading-snug mb-2'
                style={{
                    color:
                        task.status === 'done'
                            ? 'var(--color-text-muted)'
            ...
            {task.description && (
                <p
                    className='text-2xs leading-relaxed mb-3'
                    style={{ color: 'var(--color-text-muted)' }}
                >
                    {task.description}
                </p>
            ...
            >
                <div className='flex items-center justify-between'>
                    ...
                    {task.status !== 'done' && (
                        <span
                            className='text-4xs font-black tracking-widest uppercase px-2 py-0.5'
                            style={{
                                color: urgencyColor,
            ...
            <GripVertical
                className='absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 opacity-0 group-hover:opacity-20 transition-opacity'
                style={{ color: 'white' }}
            />
        </motion.div>
    );
...
export default function TaskCenterPage() {
    ...
    const addTask = useCallback((t: Task) => {
        setTasks((p) => [t, ...p]);
        import('../lib/api').then(({ trackTask }) =>
            trackTask('created').catch(() => {}),
        );
    }, []);
                        ...
                        {COLUMNS.map((col, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className='text-3xs font-black font-mono tracking-widest'
                                ...
                                >
                                    ...
                                    >
                                        <div className='flex items-center gap-3'>
                                            ...
                                            />
                                            <div>
                                                <p className='text-xs font-extrabold tracking-widest uppercase text-[var(--color-text)]'>
                                                    {col.label}
                                                </p>
                                                <p
                                                    className='text-4xs font-mono tracking-[0.2em]'
                                                    style={{
                                                        color: 'var(--color-text-muted)',
                                                    }}
                                                >
                                        ...
                                        <span
                                            className='text-3xs font-black font-mono px-3 py-1'
                                            style={{
                                                color: col.color,
                                        ...
                                        >
                                            {String(colTasks.length).padStart(
                                                2,
                                                '0',
                                            )}
                                        </span>
                                    ...
                                    <div className='grow overflow-y-auto p-3 space-y-2'>
                                        {colTasks.length === 0 ? (
                                            <div
                                                className='flex flex-col items-center justify-center h-28 border border-dashed'
                                                style={{
                                                    borderColor:
                                                        'var(--color-glass-border)',
                                                }}
