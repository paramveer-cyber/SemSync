            ...
            <div className='p-8 max-w-xl space-y-6'>
                    ...
                    {[
                        ...
                        >
                            ...
                            <div className='flex-1 min-w-0'>
                                ...
                                <p
                                    className={`text-sm truncate ${row.accent ? 'text-green-400' : 'text-[var(--color-text)]'}`}
                                >
                                    {row.value}
                                </p>
                            </div>
                ...
                >
                    ...
                    <div className='space-y-3 text-xs leading-relaxed text-[var(--color-text-muted)]'>
                        <p>
                            SemSync is a personal productivity tool. Your data
                            is stored securely and is never sold or shared with
                            third parties. Authentication is handled via Google
                            OAuth 2.0 and we only access your name, email, and
                            profile picture.
                        </p>

                        <p>
                            By using this service you agree to our Terms of
                            Service. You may request deletion of your data at
                ...
                <p
                    ...
                    style={{ color: 'var(--color-text-faint)' }}
                >
                    © 2026 SemSync. All rights reserved.
                </p>
            </div>
        </div>
    );
